...
public class DomainBitSet implements Domain {
    ...
    BitSet values; // un bitset représente le domaine (voir api java pour plus d'infos)
    int min;
    int max;
    ...
    // retourne la taille du domaine, ie le nombre de valeurs présentes dans le domaine
    public int size() {
